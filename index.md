...
<section id="intro" class="wrapper style1 fullscreen fade-up">
	<div class="inner">
		<h1>Jennifer Hiew</h1>
		<p>A digital designer with a focus on interdisciplinary design, including user experience (UX), user interface (UI), graphic, and visual design. Enjoys engaging with anything related to technology, illustration, and the arts.</p>
		<ul class="actions">
